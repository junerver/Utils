 ...
 */
object SslUtils {
    fun getSslSocketFactory(): SslParams = getSslSocketFactoryBase(null, null, null)
    ...
    private fun getSslSocketFactoryBase(
        ...
        return try {
            ...
            //创建SSL类型的SSLContext对象, that uses our TrustManager
            ...
            SslParams(sslContext.socketFactory, manager)
